...
public class TNAutoSync : TNBehaviour
{
	...
	public void Sync ()
	{
		...
		{
			if (isImportant) tno.Send(254, isSavedOnServer ? Target.OthersSaved : Target.Others, mCached);
			else tno.SendQuickly(254, isSavedOnServer ? Target.OthersSaved : Target.Others, mCached);
		}
	}
